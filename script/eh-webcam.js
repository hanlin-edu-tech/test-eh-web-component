{
    ...
    `;
    customElements.define('eh-webcam', class extends HTMLElement {
        constructor() {
            super();
            const shadowRoot = this.attachShadow({mode: 'open'});
            shadowRoot.innerHTML = template;

            const video = shadowRoot.getElementById( "webcam" );
            const liveView = shadowRoot.getElementById('liveView');
            const demosSection = shadowRoot.getElementById('demos');
            ...
            if (hasGetUserMedia()) {
                const enableWebcamButton = shadowRoot.getElementById('webcamButton');
